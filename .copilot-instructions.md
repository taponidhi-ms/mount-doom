...
**YOU MUST ALWAYS** read the memory banks in the `.memory-banks/` directory before making any changes to the codebase. The memory banks contain critical project context:
...
**YOU MUST ALWAYS** update the memory banks when making changes that affect:
