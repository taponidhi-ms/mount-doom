...
from app.services.features.conversation_simulation.conversation_simulation_service import conversation_simulation_service
from app.services.features.conversation_simulation.conversation_simulation_evals_service import conversation_simulation_evals_service
...
async def prepare_evals(request: PrepareEvalsRequest):
    ...
    """
    logger.info("Received evaluations preparation request", 
               runs_count=len(request.selected_run_ids))
