...
from app.models.db import PersonaDistributionEvalsDocument
from app.instruction_sets.persona_distribution import PERSONA_DISTRIBUTION_AGENT_INSTRUCTIONS

logger = structlog.get_logger()


class PersonaDistributionEvalsService:
    """Service for preparing evaluation datasets from persona distribution generations."""

    def _generate_evals_config(self, evals_id: str, agent_name: str = "ttulsi_persona_generator_agent") -> Dict[str, Any]:
        """
        ...
        """
        logger.info("Generating CXA evals configuration", agent_name=agent_name)
    ...
    async def save_to_database(
        ...
        document = PersonaDistributionEvalsDocument(
            id=evals_id,
...
# Singleton instance
persona_distribution_evals_service = PersonaDistributionEvalsService()
